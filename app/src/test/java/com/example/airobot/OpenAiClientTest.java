...
public class OpenAiClientTest {
    private final String defalutOpenApiHost = "https://api.chatanywhere.com.cn/";
    private final String key = "sk-GnMR9NrWFYn1kKSeEih9U71ExCfP3PX5LKsn3jQYNPp1vG33";
...
//        Edit edit = Edit.builder().input("我爱你麻麻").instruction("帮我修改错别字").model(Edit.Model.TEXT_DAVINCI_EDIT_001.getName()).build();
    ...
    public void editImageV2() {
        ...
        List<Item> images = v2.editImages(new java.io.File("D:\\Pictures\\kotlin.png"),
                imageEdit);
